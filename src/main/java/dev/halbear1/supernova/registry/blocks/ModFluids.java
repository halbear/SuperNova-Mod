...
public class ModFluids {
    ...
    public static final ForgeFlowingFluid.Properties CRUDE_OIL_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            .density(15).viscosity(10).sound(SoundEvents.BLOCK_HONEY_BLOCK_SLIDE).overlay(CRUDE_OIL_OVERLAY_RL).color(0x00FFFFFF)).slopeFindDistance(4).levelDecreasePerBlock(2)
    ...
    public static final RegistryObject<FlowingFluidBlock> CRUDE_OIL_BLOCK = ModBlocks.BLOCKS.register("crude_oil",
            () -> new FlowingFluidBlock(() -> ModFluids.CRUDE_OIL_FLUID.get(), AbstractBlock.Properties.create(Material.LAVA)
                    .doesNotBlockMovement().hardnessAndResistance(100f).noDrops()));
